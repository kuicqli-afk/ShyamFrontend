...
import SingleItemsList from "../../Components/ShopsData/SingleItemsData";
// import "./Food.css";
...
const SingleItem = ({ filter, sortBy, price, cuisine }) => {
    const navigate = useNavigate();
    const swiperRef = useRef(null);

    const { cartItems, addToCart, updateQty, getCartKey } = useCart();

    const list = useMemo(() => SingleItemsList, []);
    ...
    const placeOrder = (item) =>
        navigate("/order", {
            state: {
                ...
                category: "singleitem", // Category set to "rolls"
            },
        });

    return (
        <div id="singleitem" className="food-container">
            <div className="food-text">
                <h1>Single Items</h1>
                <p className="view-all" onClick={() => navigate("/all-single-items")}>View all</p>
            </div>
            {/* <div>
