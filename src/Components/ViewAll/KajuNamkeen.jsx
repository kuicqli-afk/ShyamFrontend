...
function KajuBhujiya() {
    ...
    const placeOrder = (item) =>
        navigate("/order#", { state: { item, category: "kajunamkeen" } });
    return (
        <div className="food-container">
            <div id="kajunamkeen" className="food-text">
                <h1>Kaju Namkeen</h1>
            </div>
