import "./Pages.css";
import kalyanpur from "../../assets/alambagh1.jpg";
...
import AlambaghListings from "../../Components/Pages/AlambaghData"
    ...
    <div className="area-page">
      <div className="area-banner">
        ...
        <div className="area-banner-overlay">
          <div className="area-banner-content">
            ...
            <div className="area-city">ALAMBAGH</div>
          </div>
        </div>
      </div>
      ...
      <div className="latest-container">
        <div className="latest-header">
          ...
          <h2>Latest Restaurant In Alambagh</h2>
          <p>
