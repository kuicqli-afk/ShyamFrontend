...
import SingleItemsList  from "../ShopsData/SingleItemsData";
...
function SingleItems() {
    ...
    const placeOrder = (item) =>
        navigate("/order#", { state: { item, category: "singleitems" } });
    return (
        <div className="food-container">
            <div id="singleitems" className="food-text">
                <h1>Single Items</h1>
            </div>
