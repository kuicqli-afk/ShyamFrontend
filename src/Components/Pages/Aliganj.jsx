import "./Pages.css";
import kalyanpur from "../../assets/aliganj1.jpg";
...
import AliganjListings from "./AliganjData";
    ...
    <div className="area-page">
      <div className="area-banner">
        ...
        <div className="area-banner-overlay">
          <div className="area-banner-content">
            ...
            <div className="area-city">Aliganj</div>
          </div>
        </div>
      </div>
      ...
      <div className="latest-container">
        <div className="latest-header">
          ...
          <h2>Latest Restaurant In Aliganj</h2>
          <p>
