...
import MaidaItemsData from "../../data/MaidaItemsData"; // only biryani items
import "./Food.css";
...
const BiryaniAll = () => {
    ...
    const placeOrder = (item) =>
        navigate("/order#", { state: { item, category: "biryani" } });
