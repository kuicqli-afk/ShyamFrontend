...
import ShyamChipsData from "../ShopsData/ShyamChipsData";
...
const Chips = ({ filter, sortBy, price, cuisine }) => {
  ...
  const list = useMemo(() => ShyamChipsData, []);
 ...
 const filteredList = useMemo(() => {
  ...
  return (
    <div id="chips" className="food-container">
      <div className="food-text">
        <h1>Chips</h1>
        <p className="view-all" onClick={() => navigate("/all-chips")}>View all</p>
      </div>
      {/* div>
