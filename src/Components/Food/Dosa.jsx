...
import dosaList from "../../data/DosaData"; // New JSON
...
const Dosa = ({ filter, sortBy, price, cuisine }) => {
  ...
  const placeOrder = (item) =>
    navigate("/order#", { state: { item, category: "dosa" } });

  return (
    <div id="dosa" className="food-container">
                    ...
                    <div className="slot-popup-content">
                      ...
                      <button
                        onClick={() => {
                          setOpenCardId(null);
                          navigate("/order#", {
                            state: { item, category: "dosa", slot: selectedSlots[item.id] },
                          });
                        }}
