...
import cakeList from "../../data/CakeData";
...
const Cake = ({ filter, sortBy, price, cuisine }) => {
 ...
 const filteredList = useMemo(() => {
  ...
  return (
    <div id="cake" className="food-container">
      <div className="food-text">
        <h1>Cake</h1>
         <p className="view-all" onClick={() => navigate("/all-cake")}>View all</p>
      </div>
      {/* div>
