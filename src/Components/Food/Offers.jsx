...
import offersList from "../../data/OffersData";
...
const Offers = ({ filter, sortBy, price, cuisine }) => {
  ...
  const placeOrder = (item) =>
    navigate("/order#", {
      state: { item, category: "offers" },
    });

  return (
    <div id="offers" className="food-container">
      <div className="food-text">
        <h1>Offers</h1>
       <p className="view-all" onClick={() => navigate("/all-offers")}>View all</p>
      </div>
      {/* <div>
