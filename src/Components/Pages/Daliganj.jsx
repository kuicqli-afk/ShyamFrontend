import "./Pages.css";
import kalyanpur from "../../assets/daliganj1.jpg";
...
import DaliganjData from "./DaliganjData";
    ...
    <div className="area-page">
      <div className="area-banner">
        ...
        <div className="area-banner-overlay">
          <div className="area-banner-content">
            ...
            <div className="area-city">DALIGANJ</div>
          </div>
        </div>
      </div>
      ...
      <div className="latest-container">
        <div className="latest-header">
          ...
          <h2>Latest Restaurant In Daliganj</h2>
          <p>
