...
import ShyamChipsData from "../../Components/ShopsData/ShyamChipsData"; // only biryani items
// import "./Food.css";
...
// const items = 
    ...
    const placeOrder = (item) =>
        navigate("/order#", { state: { item, category: "chips" } });
  return (
    <div className="food-container">
        <div id="chips" className="food-text">
          <h1>Chips </h1>
        </div>
