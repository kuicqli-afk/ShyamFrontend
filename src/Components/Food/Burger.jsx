...
const Burger = ({ filter, sortBy, price, cuisine }) => {
 ...
 const filteredList = useMemo(() => {
  ...
  const placeOrder = (item) =>
    navigate("/order#", {
      state: { item, category: "burger", slot: selectedSlots[item.id] },
    });

  return (
    <div id="burger" className="food-container">
