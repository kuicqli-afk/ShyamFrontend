...
import icecreamList from "../../data/IcecreamData";
...
const Icecream = ({ filter, sortBy, price, cuisine }) => {
    ...
    const list = useMemo(() => icecreamList, []);
    ...
    const placeOrder = (item) =>
        navigate("/order#", {
            state: { item, category: "icecream" },
        });

    return (
        <div id="icecream" className="food-container">
                        ...
                        <div className="food-card">
                            ...
                            <div className="food-image-wrapper">
                                ...
                                {item.video && item.video.endsWith(".mp4") ? (
                                    ...
                                    <iframe
                                        className="food-image"
                                        src={`${item.video2}?autoplay=1&mute=1&loop=1&controls=0`}
                                        frameBorder="0"
