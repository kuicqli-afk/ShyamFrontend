...
import pastryList from "../../data/PastryData";
...
const Pastry = ({ filter, sortBy, price, cuisine }) => {
  ...
  const placeOrder = (item) =>
    navigate("/order#", { state: { item, category: "pastry" } });

  return (
    <div id="pastry" className="food-container">
      <div className="food-text">
        <h1>Pastry</h1>
        <p className="view-all" onClick={() => navigate("/all-pastry")}>View all</p>
      </div>
      {/* <div>
