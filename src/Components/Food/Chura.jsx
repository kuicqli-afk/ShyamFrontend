...
import ChuraData from "../ShopsData/ChuraData"; // JSON data
...
const Chura = ({ filter, sortBy, price, cuisine }) => {
    const navigate = useNavigate();
    const swiperRef = useRef(null);

    const { cartItems, addToCart, updateQty, getCartKey } = useCart();

    const list = useMemo(() => ChuraData, []);
    ...
    const placeOrder = (item) =>
        navigate("/order#", {
            state: { item, category: "chura", slot: selectedSlots[item.id] },
        });

    return (
        <div id="chura" className="food-container">
            <div className="food-text">
                <h1>Chura</h1>
                <p className="view-all" onClick={() => navigate("/all-chura")}>View all</p>
            </div>
            {/* <div>
                        ...
                        <div className="food-card">
                            ...
                            <div className="food-image-wrapper">
                                ...
                                <div className="view-eye">
                                    <VscEye style={{ fontSize: "22px", color: "#fff" }} />
                                    {item.view}
                                </div>
