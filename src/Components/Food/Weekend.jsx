...
const Weekend = ({ filter, sortBy, price, cuisine }) => {
  ...
  const list = useMemo(() => weekendList, []);
  ...
  const placeOrder = (item) =>
    navigate("/order#", {
      state: { item, category: "weekend" },
    });

  return (
    <div id="weekend" className="food-container">
      <div className="food-text">
        <h1>Weekend Specials</h1>
         <p className="view-all" onClick={() => navigate("/weekend-specials")}>View all</p>
      </div>
      {/* <div>
